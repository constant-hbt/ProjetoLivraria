...
public class JIFVendaJuri extends javax.swing.JInternalFrame {

    ClienteJuridicoModel obj;
    ArrayList<ClienteJuridicoModel> listaCliJuridicos; 
    String acao;
    MidiaModel obj_mid;
    ...
    public JIFVendaJuri() {
        ...
        try{
            ...
            listaCliJuridicos = new ArrayList();
            acao = new String();
    ...
    private void initComponents() {
        ...
        jtfCnpjCli = new javax.swing.JTextField();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jlCnpj)
                        .addGap(18, 18, 18)
                        .addComponent(jtfCnpjCli, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(41, 41, 41)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jlCnpj)
                            .addComponent(jtfCnpjCli, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jlEmail)
    ...
    private void jtfPesqCliKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfPesqCliKeyReleased
        try{
            ...
            if(pesq.length() > 2){
                ...
                listaCliJuridicos = DAO.pesquisar(pesq);
                mp.setNumRows(0);
                for(ClienteJuridicoModel u: listaCliJuridicos){
                    mp.addRow(new String[]{"" + u.getId(), u.getNome_fant(), u.getCnpj(), u.getEmail()});
                }
            }
    ...
    private void jtTabelaCliMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtTabelaCliMouseClicked
        try{
            ...
            if(linha>-1){
                jlIdNumCli.setText("" + listaCliJuridicos.get(linha).getId());
                jtfNomeCli.setText(listaCliJuridicos.get(linha).getNome_fant());
                jtfCnpjCli.setText(listaCliJuridicos.get(linha).getCnpj());
                jtfEmailCli.setText(listaCliJuridicos.get(linha).getEmail());
                jtfObsCli.setText(listaCliJuridicos.get(linha).getObservacoes());
                idCliente = listaCliJuridicos.get(linha).getId();
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(this, "Erro: " + e.getMessage());
        }
    ...
    private javax.swing.JTextField jtfCnpjCli;
